...
describe Postcodesio do
  ...
  context 'requesting information from the multiple service works correctly for the first example postcode' do
    before(:all) do
      @multiple_postcode_service = Postcodesio.new.multiple_postcode_service
      @multiple_postcode_service.multiple_postcode_request(["OX49 5NU", "M32 0JG"])
    end
    ...
    it 'should retrieve a postcode no longer than 7 symbols long' do
      expect(@multiple_postcode_service.retrieve_postcode.split(' ').length).to be <= 7
    end
    ...
    it 'should retrieve eastings as an integer' do
      expect(@multiple_postcode_service.retrieve_eastings).to be_kind_of(Integer).or be(nil)
    end

    it 'should retrieve northings as an integer' do
      expect(@multiple_postcode_service.retrieve_northings).to be_kind_of(Integer).or be(nil)
    end
    ...
    it 'should retrieve NHS Health Authority as a string' do
      expect(@multiple_postcode_service.retrieve_nhs_ha).to be_kind_of(String)
    end
    ...
    it 'should retrieve european electoral region as a string' do 
      expect(@multiple_postcode_service.retrieve_european_electoral_region).to be_kind_of(String).or be(nil)
    end

    it 'should retrieve primary care trust as a string' do
      expect(@multiple_postcode_service.retrieve_primary_care_trust).to be_kind_of(String).or be(nil)
    end

    it 'should retrieve region as a string' do
      expect(@multiple_postcode_service.retrieve_region).to be_kind_of(String).or be(nil)
    end

    it 'should retrieve lsoa as a string' do
      expect(@multiple_postcode_service.retrieve_lsoa).to be_kind_of(String).or be(nil)
    end

    it 'should retrieve msoa as a string' do
      expect(@multiple_postcode_service.retrieve_msoa).to be_kind_of(String).or be(nil)
    end
    ...
    it 'should retrieve parliamentary constituency as a string' do
      expect(@multiple_postcode_service.retrieve_parliamentary_constituency).to be_kind_of(String).or be(nil)
    end

    it 'should retrieve admin district as a string' do
      expect(@multiple_postcode_service.retrieve_admin_district).to be_kind_of(String).or be(nil)
    end

    it 'should retrieve parish as a string' do
      expect(@multiple_postcode_service.retrieve_parish).to be_kind_of(String).or be(nil)
    end
    ...
    it 'should retrieve admin ward as a string' do
      expect(@multiple_postcode_service.retrieve_admin_ward).to be_kind_of(String).or be(nil)
    end
    ...
    it 'should retrieve ccg as a string' do
      expect(@multiple_postcode_service.retrieve_ccg).to be_kind_of(String).or be(nil)
    end

    it 'should retrieve nuts as a string' do
      expect(@multiple_postcode_service.retrieve_nuts).to be_kind_of(String).or be(nil)
    end
    ...
    it 'should retrieve admin district from the codes hash as a string' do
      expect(@multiple_postcode_service.retrieve_codes_admin_district).to be_kind_of(String).or be(nil)
    end

    it 'should retrieve admin county from the codes hash as a string' do
      expect(@multiple_postcode_service.retrieve_codes_admin_county).to be_kind_of(String).or be(nil)
    end

    it 'should retrieve admin ward from the codes hash as a string' do
      expect(@multiple_postcode_service.retrieve_codes_admin_ward).to be_kind_of(String).or be(nil)
    end

    it 'should retrieve parish from the codes hash as a string' do
      expect(@multiple_postcode_service.retrieve_codes_parish).to be_kind_of(String).or be(nil)
    end

    it 'should retrieve parliamentary constituency from the codes hash as a string' do
      expect(@multiple_postcode_service.retrieve_codes_parliamentary_constituency).to be_kind_of(String)
    end

    it 'should retrieve ccg from the codes hash as a string' do
      expect(@multiple_postcode_service.retrieve_codes_ccg).to be_kind_of(String).or be(nil)
    end
    ...
    it 'should retrieve nuts from the codes hash as a string' do
      expect(@multiple_postcode_service.retrieve_codes_nuts).to be_kind_of(String).or be(nil)
    end
  end
end
